          ...
          <li><a href="#">Login</a></li>
            ...
            <li><a href="#">Reserve</a></li>
  			...
  			<div class="col-12 text-center col-md-4">
                ...
                <a  style="color:#CE78E0;" href="http://zh.ink361.com/app/users/ig-4622384798/flaze25/photos" target="_blank">
    	...
    	<div class="container-fluid">
    		<div class="row text-center bottom">
    			<div class="col-xs-6 col-xs-offset-3 col-md-12">
    				<h3>Re:Serve </h3>
  				<p>&copy; 2017, Re:Serve Enterprises. All Rights Reserved </p>	
    			</div>
    		</div>
    	</div>
  </section>